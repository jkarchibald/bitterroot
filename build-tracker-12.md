...
**Read:** three phases are done & integrated (Phase 2, Phase 3, **Phase 4**). Phase 1 is
complete as biology and live, but **provisional** — it cannot close until Phase 6
(recalibration) lands (its `t==null` null branch is now dead code as of Phase 3, but the
`categoryScores` re-anchor is still owed). Don't mark Phase 1 ☑ before Phase 6. **Next
full phase: Phase 5 (light & time-of-day).**
